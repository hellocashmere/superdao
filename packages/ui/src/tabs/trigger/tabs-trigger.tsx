  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:h-8 group-data-[variant=default]/tabs-list:flex-1 group-data-[variant=default]/tabs-list:gap-2 group-data-[variant=default]/tabs-list:rounded-[4px] group-data-[variant=default]/tabs-list:px-3 group-data-[variant=default]/tabs-list:py-1 group-data-[variant=default]/tabs-list:text-[15px] group-data-[variant=default]/tabs-list:leading-6 group-data-[variant=default]/tabs-list:font-normal group-data-[variant=default]/tabs-list:text-tabs-foreground group-data-[variant=default]/tabs-list:hover:not-data-active:bg-popover group-data-[variant=default]/tabs-list:active:not-data-active:bg-tabs-active group-data-[variant=default]/tabs-list:data-active:bg-tabs-active group-data-[variant=default]/tabs-list:data-active:text-foreground group-data-[variant=default]/tabs-list:[&_svg:not([class*='size-'])]:size-4",
        "group-data-[variant=subnavigation]/tabs-list:h-10 group-data-[variant=subnavigation]/tabs-list:flex-none group-data-[variant=subnavigation]/tabs-list:gap-2 group-data-[variant=subnavigation]/tabs-list:rounded-lg group-data-[variant=subnavigation]/tabs-list:bg-card group-data-[variant=subnavigation]/tabs-list:px-4 group-data-[variant=subnavigation]/tabs-list:text-sm group-data-[variant=subnavigation]/tabs-list:leading-5 group-data-[variant=subnavigation]/tabs-list:font-semibold group-data-[variant=subnavigation]/tabs-list:text-tabs-foreground group-data-[variant=subnavigation]/tabs-list:hover:not-data-active:bg-popover group-data-[variant=subnavigation]/tabs-list:active:not-data-active:bg-background group-data-[variant=subnavigation]/tabs-list:data-active:bg-card group-data-[variant=subnavigation]/tabs-list:data-active:text-primary group-data-[variant=subnavigation]/tabs-list:[&_svg:not([class*='size-'])]:size-5",
