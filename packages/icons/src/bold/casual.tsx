...
export interface CasualBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function CasualBoldIcon({ className, ref, ...props }: CasualBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
