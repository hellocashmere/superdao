...
export interface ArrowUp2BoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function ArrowUp2BoldIcon({ className, ref, ...props }: ArrowUp2BoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
