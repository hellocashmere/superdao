...
export interface DocumentBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function DocumentBoldIcon({ className, ref, ...props }: DocumentBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
