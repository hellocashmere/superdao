...
export interface MusicRBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function MusicRBoldIcon({ className, ref, ...props }: MusicRBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
