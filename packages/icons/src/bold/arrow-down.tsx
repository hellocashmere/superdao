...
export interface ArrowDownBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function ArrowDownBoldIcon({ className, ref, ...props }: ArrowDownBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
