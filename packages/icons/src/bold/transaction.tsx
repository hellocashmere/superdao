...
export interface TransactionBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function TransactionBoldIcon({ className, ref, ...props }: TransactionBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
