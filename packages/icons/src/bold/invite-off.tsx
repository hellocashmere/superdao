...
export interface InviteOffBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function InviteOffBoldIcon({ className, ref, ...props }: InviteOffBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
