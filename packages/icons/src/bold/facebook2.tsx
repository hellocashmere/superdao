...
export interface Facebook2BoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function Facebook2BoldIcon({ className, ref, ...props }: Facebook2BoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
