...
export interface RecentBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function RecentBoldIcon({ className, ref, ...props }: RecentBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
