...
export interface TelegramBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function TelegramBoldIcon({ className, ref, ...props }: TelegramBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
