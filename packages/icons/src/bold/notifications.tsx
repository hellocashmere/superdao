...
export interface NotificationsBoldIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function NotificationsBoldIcon({ className, ref, ...props }: NotificationsBoldIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
