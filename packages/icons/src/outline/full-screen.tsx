...
export interface FullScreenIconProps extends ComponentPropsWithRef<typeof IconBase> {}

export function FullScreenIcon({ className, ref, ...props }: FullScreenIconProps) {
  return (
    <IconBase
      {...props}
      ref={ref}
