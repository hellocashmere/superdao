...
const labelsIncludeAny: FilterFn<BaseTableFeatures, LabelWalletView> = (row, _columnId, filterValue) => {
...
const columnHelper = createColumnHelper<DataTableFeatures, LabelWalletView>();
...
/**
 * Renders a compact numeric value in an audience wallet table cell.
 */
...
/**
 * Renders an audience wallet balance as compact US dollars.
 */
...
/**
 * Renders a non-compact numeric value in an audience wallet table cell.
 */
