...
/**
 * Renders the reporting overview with conversion analytics and wallet data.
 */
export function ReportingPage({ account = "cashmere.ton", className, ref, ...props }: ReportingPageProps) {
    ...
    >
      <PageHeader className="flex min-h-18 items-center">
        <div className="flex items-end gap-3">
          <h1 className="font-heading text-2xl/[28px] font-bold">{account}</h1>
          <span className="pb-0.5 text-xl/6 font-bold text-[#717a8c]">44 684</span>
        </div>
      </PageHeader>
