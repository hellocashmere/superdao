...
export interface NftCollectionsRootHeaderProps extends ComponentPropsWithRef<typeof PageHeader> {
  onClearSearch: () => void;
...
/**
 * Renders the NFT collections directory heading, count, and search field.
 */
export function NftCollectionsRootHeader({
  className,
  onClearSearch,
  onSearchChange,
  ref,
