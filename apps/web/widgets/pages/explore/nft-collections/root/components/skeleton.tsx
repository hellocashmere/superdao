...
export interface NftCollectionsRootSkeletonProps extends ComponentPropsWithRef<typeof Container> {}

const skeletonRows = Array.from({ length: 12 }, (_, index) => index);

/**
 * Renders the loading layout for the NFT collections root page.
 */
export function NftCollectionsRootSkeleton({ ref, className, ...props }: NftCollectionsRootSkeletonProps) {
	return (
		<Container
			ref={ref}
			aria-busy="true"
			data-slot="nft-collections-root-skeleton"
