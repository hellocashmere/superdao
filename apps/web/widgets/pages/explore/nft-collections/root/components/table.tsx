					...
					<TableBody>
						{collections.map((collection, index) => (
							...
							>
								...
								<TableCell className="px-5 py-0 text-right">{compact(collection.owners)}</TableCell>
								<TableCell className="px-5 py-0 text-right">{compact(collection.activeWallets)}</TableCell>
								<TableCell className="px-5 py-0 text-right">{compact(collection.supply)}</TableCell>
								<TableCell className="px-5 py-0 text-right">
									{currency(collection.price, "USD", { currencyDisplay: "narrowSymbol", notation: "compact" })}
								</TableCell>
