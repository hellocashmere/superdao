...
import type {
	...
	NftCollectionTransactionStatView,
} from "@/entities/nft-collection";
import { BarChartCard } from "@/shared/ui/charts";
import { MetricCard } from "@/shared/ui/metric-card";

import { CollectionTransactionStats } from "./transaction-stats";
...
export interface CollectionBalanceAndTransactionsProps extends ComponentPropsWithRef<"section"> {
	/**
 ...
 */
export function CollectionBalanceAndTransactions({
	ref,
	className,
	metrics,
	nftAllocation,
	...
	walletBalance,
	...props
}: CollectionBalanceAndTransactionsProps) {
	const { compact, currency, number, percentValue } = useNumberFormatter();

	return (
		<section
			ref={ref}
			data-slot="collection-balance-and-transactions"
			className={className}
			{...props}
		>
