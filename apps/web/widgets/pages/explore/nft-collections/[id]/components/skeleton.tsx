...
export interface CollectionDetailsSkeletonProps extends ComponentPropsWithRef<typeof Container> {
	tab: "insights" | "wallets";
}

/**
 * Renders the loading layout for a collection details screen.
 */
export function CollectionDetailsSkeleton({ ref, className, tab, ...props }: CollectionDetailsSkeletonProps) {
	return (
		<Container
			ref={ref}
			aria-busy="true"
			data-slot="collection-details-skeleton"
...
/**
 * Renders the wallet-tab portion of a collection details skeleton.
 */
