...
export interface CollectionWalletsExportDialogProps extends Omit<
 ...
 */
export function CollectionWalletsExportDialog(props: CollectionWalletsExportDialogProps) {
