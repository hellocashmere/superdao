...
export interface CollectionWalletLabelsProps extends ComponentPropsWithRef<"div"> {
  labels: readonly NftCollectionWalletView["labels"][number][];
}

/**
 * Renders wallet labels and exposes any overflow through a tooltip.
 */
export function CollectionWalletLabels({ className, labels, ref, ...props }: CollectionWalletLabelsProps) {
  ...
  return (
    <div
      {...props}
      ref={ref}
      data-slot="nft-collection-wallet-labels"
