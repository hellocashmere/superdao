...
import { LabelWalletsExportDialog } from "../export-dialog";
 ...
 */
export function LabelWalletsTable({ ref, className, label, toolbarActions, ...props }: LabelWalletsTableProps) {
	...
	return (
		<Card
			ref={ref}
			aria-label="Label wallets"
			aria-busy={walletsQuery.isPending}
			data-slot="label-wallets-table"
			className={className}
			{...props}
		>
								...
								>
									{table.getVisibleLeafColumns().map((column) => (
										...
										>
											...
											) : column.id === "activity" || column.id === "contacts" ? (
