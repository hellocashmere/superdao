...
export interface LabelWalletsExportDialogProps extends Omit<
	ComponentPropsWithRef<typeof Dialog>,
	"onOpenChange" | "onOpenChangeComplete" | "open"
> {}

/**
 * Renders the label wallet CSV export flow from confirmation through completion.
 */
export function LabelWalletsExportDialog(props: LabelWalletsExportDialogProps) {
