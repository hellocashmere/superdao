...
export function LabelWalletsTable({ className, label, ref, ...props }: LabelWalletsTableProps) {
  ...
  return (
    ...
    >
      ...
      <div
        data-slot="label-wallets-table-pagination"
        className="flex min-h-17 flex-wrap items-center justify-end gap-6 px-6 py-3 text-[13px]/[18px] text-tabs-foreground"
      >
