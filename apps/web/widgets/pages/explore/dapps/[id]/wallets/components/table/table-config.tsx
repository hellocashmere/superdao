...
const labelsIncludeAny: FilterFn<BaseTableFeatures, DappWalletView> = (row, _columnId, filterValue) => {
...
const columnHelper = createColumnHelper<DataTableFeatures, DappWalletView>();
...
/**
 * Renders a compact numeric value in a dapp wallet table cell.
 */
...
/**
 * Renders a dapp wallet balance as compact US dollars.
 */
...
/**
 * Renders a non-compact numeric value in a dapp wallet table cell.
 */
