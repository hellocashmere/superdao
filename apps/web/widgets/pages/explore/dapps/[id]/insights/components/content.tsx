...
export interface DappInsightBarChartProps extends ComponentPropsWithRef<typeof Card> {
...
/**
 * Renders a vertical distribution chart for dapp insights.
 */
export function DappInsightBarChart({
  className,
  data,
  description,
  ref,
...
export interface DappInsightsProps extends ComponentPropsWithRef<"div"> {
  dappID: number;
}

/**
 * Renders the complete analytics view for a dapp audience.
 */
export function DappInsights({ className, dappID, ref, ...props }: DappInsightsProps) {
