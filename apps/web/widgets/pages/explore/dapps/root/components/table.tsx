          ...
          <TableBody>
            {dapps.map((dapp, index) => (
              ...
              >
                ...
                <TableCell className="px-5 py-0 text-right">{dapp.owners}</TableCell>
                <TableCell className="px-5 py-0 text-right">{dapp.activeWallets}</TableCell>
                <TableCell className="px-5 py-0 text-right">{dapp.supply}</TableCell>
                <TableCell className="px-5 py-0 text-right">{dapp.price}</TableCell>
