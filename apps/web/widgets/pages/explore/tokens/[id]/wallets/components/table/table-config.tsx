...
const labelsIncludeAny: FilterFn<BaseTableFeatures, TokenWalletView> = (row, _columnId, filterValue) => {
...
/**
 * Renders a compact numeric value in a token wallet table cell.
 */
...
/**
 * Renders a token wallet balance as compact US dollars.
 */
...
/**
 * Renders a non-compact numeric value in a token wallet table cell.
 */
