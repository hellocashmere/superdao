...
type Contact = Exclude<TokenWalletView["contacts"][number], "email">;
...
function getContactHref(contact: Contact, wallet: TokenWalletView) {
...
export interface TokenWalletContactsProps extends ComponentPropsWithRef<"div"> {
 ...
 */
export function TokenWalletContacts({ className, ref, wallet, ...props }: TokenWalletContactsProps) {
  return (
    <div
      {...props}
      ref={ref}
      data-slot="token-wallet-contacts"
