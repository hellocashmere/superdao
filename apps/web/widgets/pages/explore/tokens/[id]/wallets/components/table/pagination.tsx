...
export interface DataTablePaginationProps extends ComponentPropsWithRef<"div"> {
  table: ReactTable<DataTableFeatures, TokenWalletView>;
}

/**
 * Renders page-size and navigation controls for the token wallet table.
 */
export function DataTablePagination({ className, ref, table, ...props }: DataTablePaginationProps) {
  ...
  return (
    <div
      {...props}
      ref={ref}
      data-slot="token-wallet-table-pagination"
      className={cn(
