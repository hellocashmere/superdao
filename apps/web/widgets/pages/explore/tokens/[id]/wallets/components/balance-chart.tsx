...
export interface TokenBalanceChartProps extends ComponentPropsWithRef<typeof Card> {
  data: readonly TokenChartDatumView[];
}

/**
 * Renders the wallet balance distribution for a token audience.
 */
export function TokenBalanceChart({ className, data, ref, ...props }: TokenBalanceChartProps) {
  return (
    <Card
      {...props}
      ref={ref}
      data-slot="token-balance-chart"
