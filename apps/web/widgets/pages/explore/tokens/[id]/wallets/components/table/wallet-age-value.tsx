...
function getAgeDetails(value: string) {
  if (isMissingTokenWalletValue(value)) return "Age unavailable";
...
export interface TokenWalletAgeValueProps extends ComponentPropsWithRef<"span"> {
  details?: string;
  value: string;
}
 ...
 */
export function TokenWalletAgeValue({ className, details, ref, value, ...props }: TokenWalletAgeValueProps) {
  ...
  return (
    <span
      {...props}
      ref={ref}
      data-slot="token-wallet-age-value"
