...
export interface TokenWalletActivityProps extends ComponentPropsWithRef<"div"> {
  activity: TokenWalletView["activity"];
}

/**
 * Renders recent activity avatars and reveals overflow in a tooltip.
 */
export function TokenWalletActivity({ activity, className, ref, ...props }: TokenWalletActivityProps) {
  ...
  return (
    <AvatarGroup
      {...props}
      ref={ref}
      data-slot="token-wallet-activity"
      data-size="xs"
