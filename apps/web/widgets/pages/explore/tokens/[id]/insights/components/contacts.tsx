...
import type { TokenInfluencerView, TokenInsightMetricView } from "@/entities/token";
import { MetricCard } from "@/shared/ui/metric-card";

export interface TokenContactsInsightsProps extends ComponentPropsWithRef<"section"> {
 ...
 */
export function TokenContactsInsights({ ref, className, influencers, metrics, ...props }: TokenContactsInsightsProps) {
	const { compact, currency, number, percentValue } = useNumberFormatter();

	return (
		<section
			ref={ref}
			data-slot="token-contacts-insights"
			className={className}
			{...props}
		>
