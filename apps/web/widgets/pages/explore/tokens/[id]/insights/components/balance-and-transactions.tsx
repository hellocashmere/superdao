...
import type { TokenChartDatumView, TokenInsightMetricView, TokenTransactionStatView } from "@/entities/token";
import { BarChartCard } from "@/shared/ui/charts";
import { MetricCard } from "@/shared/ui/metric-card";

import { TokenTransactionStats } from "./transaction-stats";
...
export interface TokenBalanceAndTransactionsProps extends ComponentPropsWithRef<"section"> {
	/**
	 * Summary metrics for wallet balances and transaction activity.
	 */
	metrics: readonly TokenInsightMetricView[];
 ...
 */
export function TokenBalanceAndTransactions({
	ref,
	className,
	metrics,
	nftAllocation,
	...
	walletBalance,
	...props
}: TokenBalanceAndTransactionsProps) {
	const { compact, currency, number, percentValue } = useNumberFormatter();

	return (
		<section
			ref={ref}
			data-slot="token-balance-and-transactions"
			className={className}
			{...props}
		>
