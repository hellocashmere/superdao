...
export interface MemberActionsMenuProps extends ComponentPropsWithRef<"div"> {
	/**
	 * Member whose available actions are displayed.
	 */
	member: CommunityMember;

	/**
	 * Removes the member identified by the supplied ID.
	 */
	onRemove: (memberID: string) => void;

	/**
	 * Assigns a new role to the member identified by the supplied ID.
	 */
...
export function MemberActionsMenu({
	...
	/**
	 * Copies the member wallet address to the clipboard.
	 */
