...
/**
 * Creates generated audience wallets for one token.
 */
function getTokensWallets(id: number): TokenWallet[] | undefined {
...
/**
 * Serves generated wallets associated with a token.
 */
export async function GET(request: Request, context: RouteParams<"tokenID">): Promise<Response> {
	const id = await routeID(context.params, "tokenID", "Invalid token id.");
	if (id instanceof Response) return id;
	let wallets = getTokensWallets(id);
