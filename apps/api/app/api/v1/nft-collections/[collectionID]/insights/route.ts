...
/**
 * Creates generated analytics for one NFT collection.
 */
function getNftCollectionsInsights(id: number): NftCollectionInsights | undefined {
...
export async function GET(_request: Request, context: RouteParams<"collectionID">): Promise<Response> {
	...
	const insights = getNftCollectionsInsights(id);
