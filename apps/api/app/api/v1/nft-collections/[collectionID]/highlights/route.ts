...
/**
 * Creates generated highlights for one NFT collection.
 */
function getNftCollectionsHighlights(id: number): NftCollectionHighlights | undefined {
...
export async function GET(_request: Request, context: RouteParams<"collectionID">): Promise<Response> {
	...
	const highlights = getNftCollectionsHighlights(id);
